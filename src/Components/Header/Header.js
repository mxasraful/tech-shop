                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                    ...
                                    <>
                                        {
                                            navItem.drop ?
                                                <>
                                                    <li class={`nav-item dropdown nav-item-${navItem.name}`}>
                                                        <a class="nav-link dropdown-toggle" href role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                            {navItem.name}
                                                        </a>
                                                        <ul class={`dropdown-menu dropdown-menu-${navItem.name}`} style={{ width: navItem.dropItems.length > 5 && "400px" }}>
                                                            <div className={navItem.dropItems.length > 5 && 'd-flex flex-wrap ps-1 text-center'}>
                                                                {
                                                                    navItem.dropItems.map(dropItem => (
                                                                        <li style={{ width: navItem.dropItems.length > 5 && "130px" }} className={navItem.dropItems.length > 5 && `mb-2 ${navItem.name}-dropdown-item`}><a class="dropdown-item" href={navItem.dropItems.length > 5 ? dropItem.url : "/category/" + dropItem.url}>{dropItem.name}</a></li>
                                                                    ))
                                                                }
                                                            </div>
                                                        </ul>
                        ...
                        <form className="d-flex" role="search">
                            ...
                            <Link to="/cart" className="btn btn-outline-danger header-desktop-cart-btn px-4 me-3 d-fex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart3 mb-1" viewBox="0 0 16 16">
                                    <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" />
                                </svg>
                                <span className='ms-1'>0</span>
