                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div className="w-100 d-flex header-search-modal-form">
                                <input class="form-control me-2" type="text" placeholder="Type product or brand name" onChange={(e) => setSearchInput(e.target.value)} />
                                <input class="btn btn-primary px-4" type="submit" value="SEARCH" onClick={() => handleSearch()} />
                            </div>
